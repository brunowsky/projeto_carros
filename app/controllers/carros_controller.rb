class CarrosController < ApplicationController
  ...
  def index
    ...
    @quantidade_carros = @carros.count

    @valor_total_inventario = @carros.sum(:preço)
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to carros_url, notice: "Carro foi deletado com sucesso." }
  ...
  private
    ...
    def carro_params
      params.require(:carro).permit(:fabricante, :modelo, :ano, :preço, :placa)
    end
end
